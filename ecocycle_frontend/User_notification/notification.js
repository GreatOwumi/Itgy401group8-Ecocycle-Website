document.addEventListener("DOMContentLoaded", () => {
  ...
  if (activeLink) {
    // Find the nearest preceding <span> (category name) before the active link
    const categorySpan = activeLink.closest("ul").querySelector("li > span");

    // Ensure the breadcrumb only updates if the categorySpan and active link are valid
    if (categorySpan) {
